...
<nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?=getenv("ROOT")?>"><img src="https://www.imobibrasil.com.br/imagens/logo.png" alt=""
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="<?=getenv("ROOT") . "pages/formulario.php"?>">Create Anuncio</a>
                </li>
            </ul>
        </div>
    </div>
